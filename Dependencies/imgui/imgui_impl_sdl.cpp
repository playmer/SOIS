...
static bool         g_MouseDoubleClicked[3] = { false, false, false };
    ...
    case SDL_MOUSEBUTTONDOWN:
        {
            if (event->button.button == SDL_BUTTON_LEFT)
            {
              ...
              if (2 == event->button.clicks) g_MouseDoubleClicked[0] = true;
            }
            ...
            if (event->button.button == SDL_BUTTON_RIGHT)
            {
              ...
              if (2 == event->button.clicks) g_MouseDoubleClicked[1] = true;
            }
            if (event->button.button == SDL_BUTTON_MIDDLE)
            {
              g_MousePressed[2] = true;

              if (2 == event->button.clicks) g_MouseDoubleClicked[2] = true;
            }
            return true;
        }
    case SDL_TEXTINPUT:
...
static void ImGui_ImplSDL2_UpdateMousePosAndButtons()
{
    ...
    io.MouseDoubleClicked[0] = g_MouseDoubleClicked[0];
    io.MouseDoubleClicked[1] = g_MouseDoubleClicked[1];
    io.MouseDoubleClicked[2] = g_MouseDoubleClicked[2];
    g_MouseDoubleClicked[0] = g_MouseDoubleClicked[1] = g_MouseDoubleClicked[2] = false;
